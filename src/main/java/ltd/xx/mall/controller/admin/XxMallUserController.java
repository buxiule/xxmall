...
public class XxMallUserController {

    @Resource
    private XxMallUserService xxMallUserService;
    ...
    public Result list(@RequestParam Map<String, Object> params) {
        ...
        return ResultGenerator.genSuccessResult(xxMallUserService.getNewBeeMallUsersPage(pageUtil));
    }
    ...
    public Result delete(@RequestBody Integer[] ids, @PathVariable int lockStatus) {
        ...
        if (xxMallUserService.lockUsers(ids, lockStatus)) {
