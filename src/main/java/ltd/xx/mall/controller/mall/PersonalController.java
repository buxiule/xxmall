...
public class PersonalController {
    ...
    public Result login(@RequestParam("loginName") String loginName,
        ...
        //todo 清verifyCode
        String loginResult = xxMallUserService.login(loginName, MD5Util.MD5Encode(password, "UTF-8"), httpSession);
        //登录成功
    ...
    public Result register(@RequestParam("loginName") String loginName,
        ...
        //todo 清verifyCode
        String registerResult = xxMallUserService.register(loginName, password);
        //注册成功
